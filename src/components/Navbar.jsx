...
const navbarLinks = [
  { label: "Home", href: "/gobackend", ariaLabel: "Home" },
  {
    label: "Machine Coding",
    href: "/gobackend/machine-coding/like-button",
    ariaLabel: "Machine Coding",
  },
  { label: "Feedback", href: "/gobackend", ariaLabel: "Feedback" },
  { label: "FAQ", href: "/gobackend", ariaLabel: "FAQ" },
];
    ...
    >
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex justify-between items-center relative">
        <motion.div
          ...
          exit={{ opacity: 0 }}
        >
          <a href="/gobackend" aria-label="Home">
